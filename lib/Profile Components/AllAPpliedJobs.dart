// ignore_for_file: unused_import, unnecessary_null_comparison, prefer_const_constructors_in_immutables, file_names, use_key_in_widget_constructors, prefer_const_constructors, library_private_types_in_public_api
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Tất cả công việc đang ứng tuyển', style: TextStyle(color: Colors.white)),
                          ...
                          if (companyName != null && jobTitle != null) {
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: ListTile(
                                  title: Text('Công ty: $companyName'),
                                  subtitle: Text('Tiêu đề công việc: $jobTitle'),
                                  trailing: Icon(
                                    Icons.chat,
                                    color: Colors.white,
                                  ),
