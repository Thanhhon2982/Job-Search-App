// ignore_for_file: file_names, prefer_const_constructors_in_immutables, use_key_in_widget_constructors, library_private_types_in_public_api, unnecessary_cast, avoid_print, prefer_const_constructors
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            ...
                            child: CircleAvatar(
                              radius: 60,
                              backgroundImage: AssetImage('assets/nth1.png'),
                            ),
                          ),
                          SizedBox(height: 4),
                          Card(
                                            ...
                                            ListTile(
                                              ...
                                              subtitle: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Mô tả: ${experience['description'] ?? 'N/A'}',
                                                    style:
                                                        TextStyle(fontSize: 15),
                                                  ),
                                                  Text(
