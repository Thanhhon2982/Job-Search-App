// ignore_for_file: unused_import, unused_local_variable, file_names, use_key_in_widget_constructors, prefer_const_constructors
                            ...
                            return GestureDetector(
                              ...
                              child: Card(
                                child: Container(
                                  ...
                                  child: ListTile(
                                    title: Text('Khả dụng: $availability'),
                                    trailing: Icon(
                                      Icons.chat,
                                      color: Colors.blue,
                                    ),
                                    subtitle: Column(
                                      ...
                                      children: [
                                        Text('Kinh nghiệm: $experience'),
                                        Text('Dự án: $projects'),
                                        Text(
                                            'Mức lương mong muốn: $salaryExpectation'),
                                      ],
                                    ),
                                  ),
                                ),
